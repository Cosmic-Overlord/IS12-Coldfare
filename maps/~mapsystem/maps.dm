...
/datum/map
	...
	//Economy stuff
	var/starting_money = 5000		//Money in station account
	var/department_money = 500		//Money in department accounts
	...
	var/map_lore = null //This is a string, write your fancy map lore here.
...
//For small ruin generation.
proc/do_small_ruin_generation(list/z_levels = null, list/templates = null, amount = 1)
	var/list/spawn_templates = templates
	var/list/feature_types = templates.Copy()
	spawn_templates.Cut()
