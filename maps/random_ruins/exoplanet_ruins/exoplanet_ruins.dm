...
/datum/map_template/ruin/exoplanet/randbuilding1
	name = "Building"
	id = "building1"
	description = "red team."
	suffixes = list("building1.dmm")
	cost = 1

/datum/map_template/ruin/exoplanet/randbuilding2
	name = "Building"
	id = "building1"
	description = "red team."
	suffixes = list("building2.dmm")
	cost = 1

/datum/map_template/ruin/exoplanet/randbuilding3
	name = "Building"
	id = "building3"
	description = "red team."
	suffixes = list("building3.dmm")
	cost = 1