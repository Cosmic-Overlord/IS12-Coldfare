/datum/hud_data
	...
	var/list/gear = list(
		...
		"o_clothing" =   list("loc" = ui_oclothing, "name" = "Suit",         "slot" = slot_wear_suit, "state" = "suit"),
		...
		"head" =         list("loc" = ui_head,      "name" = "Hat",          "slot" = slot_head,      "state" = "hair"),
		"shoes" =        list("loc" = ui_shoes,     "name" = "Shoes",        "slot" = slot_shoes,     "state" = "shoes",  "toggle" = 1),
		"back2" = 		 list("loc" = ui_sstore1,   "name" = "Back2",		 "slot" = slot_s_store,   "state" = "suitstore", "toggle" = 1),
		"back" =         list("loc" = ui_back,      "name" = "Back",         "slot" = slot_back,      "state" = "back"),
		"id" =           list("loc" = ui_id,        "name" = "ID",           "slot" = slot_wear_id,   "state" = "id"),
		"storage1" =     list("loc" = ui_storage1,  "name" = "Left Pocket",  "slot" = slot_l_store,   "state" = "pocket"),
		"storage2" =     list("loc" = ui_storage2,  "name" = "Right Pocket", "slot" = slot_r_store,   "state" = "pocket"),
		"chest_holster"= list("loc" = ui_chest_slot,"name" = "Chest Holster","slot" = slot_chest, 	  "state" = "chest_holster"),
		"neck" =		 list("loc" = ui_neck,		"name" = "Neck",		 "slot" = slot_tie,		  "state" = "neck", "toggle" = 1),
