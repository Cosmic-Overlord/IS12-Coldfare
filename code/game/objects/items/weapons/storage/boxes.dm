...
/obj/item/storage/box/matches
	...
	icon_state = "matchbox"
	item_state = "zippo"
	use_sound = 'sound/items/handle/matchbox_pickup.ogg'
	drop_sound = 'sound/items/handle/matchbox_drop.ogg'
	...
	attackby(obj/item/flame/match/W as obj, mob/user as mob)
		if(istype(W) && !W.lit && !W.burnt)
			...
			if(prob(50))
				...
				return
			playsound(src.loc, 'sound/items/matchstick_lit.ogg', 60, 1, -4)
			W.lit = 1
			W.damtype = "burn"
...
/obj/item/storage/box/mre
	...
	startswith = list(/obj/item/storage/box/matches/small = 1,
				...
				/obj/item/reagent_containers/food/condiment/sugarpack = 1,
				/obj/item/storage/fancy/cigarettes/heavy = 1)

/obj/item/storage/box/mre/var1
	name = "Genericstan \"veggie\" rations"
	w_class = 3
