...
/obj/machinery/computer/robotics/proc/get_cyborgs(var/mob/opperator)
	...
	for(var/mob/living/silicon/robot/R in GLOB.silicon_mob_list)
		...
		if(opperator && istype(opperator, /mob/living/silicon/ai) && (R.connected_ai == opperator) && (opperator.mind.special_role && opperator.mind.original == opperator))
